package cn.rainyak.chatgpt.interfaces;

import cn.rainyak.chatgpt.application.IWeiXinValidateService;
import cn.rainyak.chatgpt.common.Constants;
import cn.rainyak.chatgpt.domain.chat.ChatCompletionRequest;
import cn.rainyak.chatgpt.domain.chat.ChatCompletionResponse;
import cn.rainyak.chatgpt.domain.chat.Message;
import cn.rainyak.chatgpt.domain.receive.model.MessageTextEntity;
import cn.rainyak.chatgpt.infrastructure.util.XmlUtil;
import cn.rainyak.chatgpt.session.Configuration;
import cn.rainyak.chatgpt.session.OpenAiSession;
import cn.rainyak.chatgpt.session.OpenAiSessionFactory;
import cn.rainyak.chatgpt.session.defaults.DefaultOpenAiSessionFactory;
...
public class WeiXinPortalController {
    ...
    public WeiXinPortalController() {
        ...
        configuration.setApiKey("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");
